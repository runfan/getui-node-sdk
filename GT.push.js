...
class GeTui {
    get instance() {
        return this._instance[this._appkey];
    }
    getFaster() {
        var hosts = this._serviceMap[this._appkey];
     ...
     * @constructor
     */
    constructor(host, appkey, masterSecret) {
        this._instance = []
        this._serviceMap = [];
        if (this._instance[appkey] == null) {
            this._appkey = appkey;
     ...
     */
    cancelContentId(contentId, callback) {
        var postData = {
     ...
     * @return
     */
    pushMessageToList(contentId, targetList, callback) {
        var cidList = [];
        var aliasList = [];
        var appId = null;
     ...
     * @return
     */
    pushMessageToApp(message, taskGroupName, callback) {
        if (typeof taskGroupName === 'function') {
            callback = taskGroupName;
            taskGroupName = null;
        }
     ...
     * @param callback
     */
    pushAPNMessageToSingle(appId, deviceToken, message, callback) {
    ...
    getAPNContentId(appId, message, callback) {
        var postData = {
    ...
    getClientIdStatus(appId, clientId, callback) {
        var postData = {
    ...
    setClientTag(appId, clientId, tags, callback) {
        var postData = {
            action: 'setTagAction',
            appkey: this._appkey,
            appId: appId,
     ...
     * @param callback
     */
    bindAlias(appId, alias, clientId, callback) {
        var postData = {
            appkey: this._appkey,
            appid: appId
        };
    ...
    queryAlias(appId, clientId, callback) {
        var postData = {
            action: 'alias_query',
            appkey: this._appkey,
            appid: appId,
     ...
     * @param callback
     */
    unBindAlias(appId, alias, clientId, callback) {
        var postData = {
            action: 'alias_unbind',
            appkey: this._appkey,
            appid: appId,
    ...
    getUserTags(appId, clientId, callback) {
        var postData = {
            action: 'getUserTags',
            appkey: this._appkey,
            appId: appId,
